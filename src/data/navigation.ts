...
export const navigationData: NavCategory[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'XGBoost Concept', route: '/ml/supervised/xgboost-concept', badge: 'Concept' },
    ],
  },
  {
    category: 'Clustering',
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'UMAP Concept', route: '/ml/dimensionality-reduction/umap-concept', badge: 'Concept' },
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'ARIMA Concept', route: '/ml/time-series/arima-concept', badge: 'Concept' },
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Word Embedding Concept', route: '/ml/nlp/word-embedding-concept', badge: 'Concept' },
  ...
  },
  {
    ...
    icon: 'Eye',
    items: [
      { label: 'Image Classification', route: '/ml/computer-vision/image-classification', badge: 'Browser Inference' },
      ...
      { label: 'Object Detection Demo', route: '/ml/computer-vision/object-detection-demo', badge: 'Browser Inference' },
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'SHAP Concept', route: '/ml/explainability/shap-concept', badge: 'Concept' },
      { label: 'LIME Concept', route: '/ml/explainability/lime-concept', badge: 'Concept' },
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'AutoML Concept Lab', route: '/ml/lab/automl-concept', badge: 'Concept' },
