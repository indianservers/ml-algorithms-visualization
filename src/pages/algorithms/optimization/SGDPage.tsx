...
const config = {
  ...
  "subtitle": "Interactive browser-only Stochastic Gradient Descent module with local datasets, controls, visualizations, metrics, and exports.",
  "category": "Optimization",
  "badge": "Intermediate",
  "explanation": "Stochastic Gradient Descent runs as an interactive browser workbench. It provides algorithm-specific controls, browser-local dataset input, computed visualizations, live metrics, prediction or inspection output, limitations, and export actions without Python, a backend, or cloud ML APIs.",
  "hyperparameters": [
    [
      "Primary control",
      "Editable",
  ...
  "predictionDetails": [
    "Use the controls to inspect Stochastic Gradient Descent outputs on new examples.",
    "Outputs are computed locally in the browser session."
  ],
  "chartTitle": "Stochastic Gradient Descent Visualization",
  "chartLabels": [
    "Input",
    "Step",
    "Model",
  ...
  "modelOutput": [
    "Stochastic Gradient Descent parameters shown here",
    "intermediate values update per run",
    "predictions and reports are exportable"
  ],
  "warnings": [
    "Stochastic Gradient Descent is educational and browser-sized by default.",
  ...
  "learning": {
    "does": "Runs and visualizes Stochastic Gradient Descent in the browser.",
    "when": "Use it when Stochastic Gradient Descent matches the learning or experimentation goal.",
    "math": "The page highlights the core formula, matrix, loss, distance, probability, or update rule used by Stochastic Gradient Descent.",
