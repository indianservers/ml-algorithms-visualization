...
const config = {
  ...
  "icon": "regression",
  "title": "Holt Winters",
  "subtitle": "Interactive browser-only Holt Winters module with local datasets, controls, visualizations, metrics, and exports.",
  "category": "Time Series",
  "badge": "Intermediate",
  "explanation": "Holt Winters has a dedicated physical lazy-loaded page. It provides algorithm-specific controls, browser-local dataset input, visualization, metrics, prediction or inspection output, limitations, and export actions without Python, a backend, or cloud ML APIs.",
  "hyperparameters": [
    [
      "Primary control",
      "Editable",
  ...
  "predictionDetails": [
    "Use the controls to inspect Holt Winters outputs on new examples.",
    "Outputs are computed locally in the browser session."
  ],
  "chartTitle": "Holt Winters Visualization",
  "chartLabels": [
    "Input",
    "Step",
    "Model",
  ...
  "modelOutput": [
    "Holt Winters parameters shown here",
    "intermediate values update per run",
    "predictions and reports are exportable"
  ],
  "warnings": [
    "Holt Winters is educational and browser-sized by default.",
  ...
  "learning": {
    "does": "Runs and visualizes Holt Winters in the browser.",
    "when": "Use it when Holt Winters matches the learning or experimentation goal.",
    "math": "The page highlights the core formula, matrix, loss, distance, probability, or update rule used by Holt Winters.",
