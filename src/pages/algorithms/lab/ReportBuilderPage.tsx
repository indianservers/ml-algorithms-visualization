...
const config = {
  ...
  "subtitle": "Interactive browser-only Report Builder module with local datasets, controls, visualizations, metrics, and exports.",
  "category": "Lab",
  "badge": "Intermediate",
  "explanation": "Report Builder has a dedicated physical lazy-loaded page. It provides algorithm-specific controls, browser-local dataset input, visualization, metrics, prediction or inspection output, limitations, and export actions without Python, a backend, or cloud ML APIs.",
  "hyperparameters": [
    [
      "Primary control",
      "Editable",
  ...
  "predictionDetails": [
    "Use the controls to inspect Report Builder outputs on new examples.",
    "Outputs are computed locally in the browser session."
  ],
  "chartTitle": "Report Builder Visualization",
  "chartLabels": [
    "Input",
    "Step",
    "Model",
  ...
  "modelOutput": [
    "Report Builder parameters shown here",
    "intermediate values update per run",
    "predictions and reports are exportable"
  ],
  "warnings": [
    "Report Builder is educational and browser-sized by default.",
  ...
  "learning": {
    "does": "Runs and visualizes Report Builder in the browser.",
    "when": "Use it when Report Builder matches the learning or experimentation goal.",
    "math": "The page highlights the core formula, matrix, loss, distance, probability, or update rule used by Report Builder.",
