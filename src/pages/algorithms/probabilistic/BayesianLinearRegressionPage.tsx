...
const config = {
  ...
  "subtitle": "Interactive browser-only Bayesian Linear Regression module with local datasets, controls, visualizations, metrics, and exports.",
  "category": "Probabilistic",
  "badge": "Intermediate",
  "explanation": "Bayesian Linear Regression runs as an interactive browser workbench. It provides algorithm-specific controls, browser-local dataset input, computed visualizations, live metrics, prediction or inspection output, limitations, and export actions without Python, a backend, or cloud ML APIs.",
  "hyperparameters": [
    [
      "Primary control",
      "Editable",
  ...
  "predictionDetails": [
    "Use the controls to inspect Bayesian Linear Regression outputs on new examples.",
    "Outputs are computed locally in the browser session."
  ],
  "chartTitle": "Bayesian Linear Regression Visualization",
  "chartLabels": [
    "Input",
    "Step",
    "Model",
  ...
  "modelOutput": [
    "Bayesian Linear Regression parameters shown here",
    "intermediate values update per run",
    "predictions and reports are exportable"
  ],
  "warnings": [
    "Bayesian Linear Regression is educational and browser-sized by default.",
  ...
  "learning": {
    "does": "Runs and visualizes Bayesian Linear Regression in the browser.",
    "when": "Use it when Bayesian Linear Regression matches the learning or experimentation goal.",
    "math": "The page highlights the core formula, matrix, loss, distance, probability, or update rule used by Bayesian Linear Regression.",
