...
const config = {
  ...
  "subtitle": "Interactive browser-only Feature Selection module with local datasets, controls, visualizations, metrics, and exports.",
  "category": "Preprocessing",
  "badge": "Intermediate",
  "explanation": "Feature Selection has a dedicated physical lazy-loaded page. It provides algorithm-specific controls, browser-local dataset input, visualization, metrics, prediction or inspection output, limitations, and export actions without Python, a backend, or cloud ML APIs.",
  "hyperparameters": [
    [
      "Primary control",
      "Editable",
  ...
  "predictionDetails": [
    "Use the controls to inspect Feature Selection outputs on new examples.",
    "Outputs are computed locally in the browser session."
  ],
  "chartTitle": "Feature Selection Visualization",
  "chartLabels": [
    "Input",
    "Step",
    "Model",
  ...
  "modelOutput": [
    "Feature Selection parameters shown here",
    "intermediate values update per run",
    "predictions and reports are exportable"
  ],
  "warnings": [
    "Feature Selection is educational and browser-sized by default.",
  ...
  "learning": {
    "does": "Runs and visualizes Feature Selection in the browser.",
    "when": "Use it when Feature Selection matches the learning or experimentation goal.",
    "math": "The page highlights the core formula, matrix, loss, distance, probability, or update rule used by Feature Selection.",
