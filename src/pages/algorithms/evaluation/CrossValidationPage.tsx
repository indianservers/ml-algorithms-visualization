...
const config = {
  ...
  "subtitle": "Interactive browser-only Cross Validation module with local datasets, controls, visualizations, metrics, and exports.",
  "category": "Evaluation",
  "badge": "Intermediate",
  "explanation": "Cross Validation has a dedicated physical lazy-loaded page. It provides algorithm-specific controls, browser-local dataset input, visualization, metrics, prediction or inspection output, limitations, and export actions without Python, a backend, or cloud ML APIs.",
  "hyperparameters": [
    [
      "Primary control",
      "Editable",
  ...
  "predictionDetails": [
    "Use the controls to inspect Cross Validation outputs on new examples.",
    "Outputs are computed locally in the browser session."
  ],
  "chartTitle": "Cross Validation Visualization",
  "chartLabels": [
    "Input",
    "Step",
    "Model",
  ...
  "modelOutput": [
    "Cross Validation parameters shown here",
    "intermediate values update per run",
    "predictions and reports are exportable"
  ],
  "warnings": [
    "Cross Validation is educational and browser-sized by default.",
  ...
  "learning": {
    "does": "Runs and visualizes Cross Validation in the browser.",
    "when": "Use it when Cross Validation matches the learning or experimentation goal.",
    "math": "The page highlights the core formula, matrix, loss, distance, probability, or update rule used by Cross Validation.",
