...
const config = {
  ...
  "subtitle": "Interactive browser-only Object Detection Demo module with local datasets, controls, visualizations, metrics, and exports.",
  "category": "Computer Vision",
  "badge": "Intermediate",
  "explanation": "Object Detection Demo has a dedicated physical lazy-loaded page. It provides algorithm-specific controls, browser-local dataset input, visualization, metrics, prediction or inspection output, limitations, and export actions without Python, a backend, or cloud ML APIs.",
  "hyperparameters": [
    [
      "Primary control",
      "Editable",
  ...
  "workflow": [
    "Prepare data for Object Detection Demo",
  ...
  "predictionDetails": [
    "Use the controls to inspect Object Detection Demo outputs on new examples.",
    "Outputs are computed locally in the browser session."
  ],
  "chartTitle": "Object Detection Demo Visualization",
  "chartLabels": [
    "Input",
    "Step",
    "Model",
  ...
  "modelOutput": [
    "Object Detection Demo parameters shown here",
    "intermediate values update per run",
    "predictions and reports are exportable"
  ],
  "warnings": [
    "Object Detection Demo is educational and browser-sized by default.",
  ...
  "learning": {
    "does": "Runs and visualizes Object Detection Demo in the browser.",
    "when": "Use it when Object Detection Demo matches the learning or experimentation goal.",
    "math": "The page highlights the core formula, matrix, loss, distance, probability, or update rule used by Object Detection Demo.",
