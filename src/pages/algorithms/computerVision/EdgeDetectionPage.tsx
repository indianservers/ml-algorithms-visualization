...
const config = {
  ...
  "subtitle": "Interactive browser-only Edge Detection module with local datasets, controls, visualizations, metrics, and exports.",
  "category": "Computer Vision",
  "badge": "Intermediate",
  "explanation": "Edge Detection has a dedicated physical lazy-loaded page. It provides algorithm-specific controls, browser-local dataset input, visualization, metrics, prediction or inspection output, limitations, and export actions without Python, a backend, or cloud ML APIs.",
  "hyperparameters": [
    [
      "Primary control",
      "Editable",
  ...
  "workflow": [
    "Prepare data for Edge Detection",
  ...
  "predictionDetails": [
    "Use the controls to inspect Edge Detection outputs on new examples.",
    "Outputs are computed locally in the browser session."
  ],
  "chartTitle": "Edge Detection Visualization",
  "chartLabels": [
    "Input",
    "Step",
    "Model",
  ...
  "modelOutput": [
    "Edge Detection parameters shown here",
    "intermediate values update per run",
    "predictions and reports are exportable"
  ],
  "warnings": [
    "Edge Detection is educational and browser-sized by default.",
  ...
  "learning": {
    "does": "Runs and visualizes Edge Detection in the browser.",
    "when": "Use it when Edge Detection matches the learning or experimentation goal.",
    "math": "The page highlights the core formula, matrix, loss, distance, probability, or update rule used by Edge Detection.",
