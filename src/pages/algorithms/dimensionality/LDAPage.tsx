...
const config = {
  ...
  "icon": "dimensionality",
  "title": "LDA",
  "subtitle": "Interactive browser-only LDA module with local datasets, controls, visualizations, metrics, and exports.",
  "category": "Dimensionality Reduction",
  "badge": "Intermediate",
  "explanation": "LDA runs as an interactive browser workbench. It provides algorithm-specific controls, browser-local dataset input, computed visualizations, live metrics, prediction or inspection output, limitations, and export actions without Python, a backend, or cloud ML APIs.",
  "hyperparameters": [
    [
      "Primary control",
      "Editable",
  ...
  "predictionDetails": [
    "Use the controls to inspect LDA outputs on new examples.",
    "Outputs are computed locally in the browser session."
  ],
  "chartTitle": "LDA Visualization",
  "chartLabels": [
    "Input",
    "Step",
    "Model",
  ...
  "modelOutput": [
    "LDA parameters shown here",
    "intermediate values update per run",
    "predictions and reports are exportable"
  ],
  "warnings": [
    "LDA is educational and browser-sized by default.",
  ...
  "learning": {
    "does": "Runs and visualizes LDA in the browser.",
    "when": "Use it when LDA matches the learning or experimentation goal.",
    "math": "The page highlights the core formula, matrix, loss, distance, probability, or update rule used by LDA.",
