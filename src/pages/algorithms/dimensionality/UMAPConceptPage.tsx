...
const config = {
  ...
  "icon": "dimensionality",
  "title": "UMAPConcept",
  "subtitle": "Interactive browser-only UMAPConcept module with local datasets, controls, visualizations, metrics, and exports.",
  "category": "Dimensionality Reduction",
  "badge": "Concept",
  "explanation": "UMAPConcept has a dedicated physical lazy-loaded page. It provides algorithm-specific controls, browser-local dataset input, visualization, metrics, prediction or inspection output, limitations, and export actions without Python, a backend, or cloud ML APIs.",
  "hyperparameters": [
    [
      "Primary control",
      "Editable",
  ...
  "predictionDetails": [
    "Use the controls to inspect UMAPConcept outputs on new examples.",
    "Outputs are computed locally in the browser session."
  ],
  "chartTitle": "UMAPConcept Visualization",
  "chartLabels": [
    "Input",
    "Step",
    "Model",
  ...
  "modelOutput": [
    "UMAPConcept parameters shown here",
    "intermediate values update per run",
    "predictions and reports are exportable"
  ],
  "warnings": [
    "UMAPConcept is educational and browser-sized by default.",
  ...
  "learning": {
    "does": "Runs and visualizes UMAPConcept in the browser.",
    "when": "Use it when UMAPConcept matches the learning or experimentation goal.",
    "math": "The page highlights the core formula, matrix, loss, distance, probability, or update rule used by UMAPConcept.",
