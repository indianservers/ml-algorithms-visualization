...
const config = {
  ...
  "subtitle": "Interactive browser-only Matrix Factorization module with local datasets, controls, visualizations, metrics, and exports.",
  "category": "Recommendation",
  "badge": "Intermediate",
  "explanation": "Matrix Factorization runs as an interactive browser workbench. It provides algorithm-specific controls, browser-local dataset input, computed visualizations, live metrics, prediction or inspection output, limitations, and export actions without Python, a backend, or cloud ML APIs.",
  "hyperparameters": [
    [
      "Primary control",
      "Editable",
  ...
  "predictionDetails": [
    "Use the controls to inspect Matrix Factorization outputs on new examples.",
    "Outputs are computed locally in the browser session."
  ],
  "chartTitle": "Matrix Factorization Visualization",
  "chartLabels": [
    "Input",
    "Step",
    "Model",
  ...
  "modelOutput": [
    "Matrix Factorization parameters shown here",
    "intermediate values update per run",
    "predictions and reports are exportable"
  ],
  "warnings": [
    "Matrix Factorization is educational and browser-sized by default.",
  ...
  "learning": {
    "does": "Runs and visualizes Matrix Factorization in the browser.",
    "when": "Use it when Matrix Factorization matches the learning or experimentation goal.",
    "math": "The page highlights the core formula, matrix, loss, distance, probability, or update rule used by Matrix Factorization.",
