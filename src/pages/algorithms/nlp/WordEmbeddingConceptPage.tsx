...
const config = {
  ...
  "subtitle": "Interactive browser-only word embedding module with local datasets, controls, visualizations, metrics, and exports.",
  "category": "NLP",
  "badge": "Intermediate",
  "explanation": "Word Embedding runs as an interactive browser workbench. It provides algorithm-specific controls, browser-local dataset input, computed visualizations, live metrics, prediction or inspection output, limitations, and export actions without Python, a backend, or cloud ML APIs.",
  "hyperparameters": [
    [
      "Primary control",
      "Editable",
  ...
  "predictionDetails": [
    "Use the controls to inspect Word Embedding outputs on new examples.",
    "Outputs are computed locally in the browser session."
  ],
  "chartTitle": "Word Embedding Visualization",
  "chartLabels": [
    "Input",
    "Step",
    "Model",
  ...
  "modelOutput": [
    "Word Embedding parameters shown here",
    "intermediate values update per run",
    "predictions and reports are exportable"
  ],
  "warnings": [
    "Word Embedding is educational and browser-sized by default.",
  ...
  "learning": {
    "does": "Runs and visualizes Word Embedding in the browser.",
    "when": "Use it when Word Embedding matches the learning or experimentation goal.",
    "math": "The page highlights the core formula, matrix, loss, distance, probability, or update rule used by Word Embedding.",
