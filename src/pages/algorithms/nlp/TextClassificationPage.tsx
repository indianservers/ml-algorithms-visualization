...
const config = {
  ...
  "subtitle": "Interactive browser-only Text Classification module with local datasets, controls, visualizations, metrics, and exports.",
  "category": "NLP",
  "badge": "Intermediate",
  "explanation": "Text Classification has a dedicated physical lazy-loaded page. It provides algorithm-specific controls, browser-local dataset input, visualization, metrics, prediction or inspection output, limitations, and export actions without Python, a backend, or cloud ML APIs.",
  "hyperparameters": [
    [
      "Primary control",
      "Editable",
  ...
  "predictionDetails": [
    "Use the controls to inspect Text Classification outputs on new examples.",
    "Outputs are computed locally in the browser session."
  ],
  "chartTitle": "Text Classification Visualization",
  "chartLabels": [
    "Input",
    "Step",
    "Model",
  ...
  "modelOutput": [
    "Text Classification parameters shown here",
    "intermediate values update per run",
    "predictions and reports are exportable"
  ],
  "warnings": [
    "Text Classification is educational and browser-sized by default.",
  ...
  "learning": {
    "does": "Runs and visualizes Text Classification in the browser.",
    "when": "Use it when Text Classification matches the learning or experimentation goal.",
    "math": "The page highlights the core formula, matrix, loss, distance, probability, or update rule used by Text Classification.",
