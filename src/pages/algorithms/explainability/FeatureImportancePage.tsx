...
const config = {
  ...
  "subtitle": "Interactive browser-only Feature Importance module with local datasets, controls, visualizations, metrics, and exports.",
  "category": "Explainability",
  "badge": "Intermediate",
  "explanation": "Feature Importance runs as an interactive browser workbench. It provides algorithm-specific controls, browser-local dataset input, computed visualizations, live metrics, prediction or inspection output, limitations, and export actions without Python, a backend, or cloud ML APIs.",
  "hyperparameters": [
    [
      "Primary control",
      "Editable",
  ...
  "predictionDetails": [
    "Use the controls to inspect Feature Importance outputs on new examples.",
    "Outputs are computed locally in the browser session."
  ],
  "chartTitle": "Feature Importance Visualization",
  "chartLabels": [
    "Input",
    "Step",
    "Model",
  ...
  "modelOutput": [
    "Feature Importance parameters shown here",
    "intermediate values update per run",
    "predictions and reports are exportable"
  ],
  "warnings": [
    "Feature Importance is educational and browser-sized by default.",
  ...
  "learning": {
    "does": "Runs and visualizes Feature Importance in the browser.",
    "when": "Use it when Feature Importance matches the learning or experimentation goal.",
    "math": "The page highlights the core formula, matrix, loss, distance, probability, or update rule used by Feature Importance.",
