...
const config = {
  ...
  "icon": "deep",
  "title": "LSTM",
  "subtitle": "Interactive browser-only LSTM module with local datasets, controls, visualizations, metrics, and exports.",
  "category": "Deep Learning",
  "badge": "Intermediate",
  "explanation": "LSTM has a dedicated physical lazy-loaded page. It provides algorithm-specific controls, browser-local dataset input, visualization, metrics, prediction or inspection output, limitations, and export actions without Python, a backend, or cloud ML APIs.",
  "hyperparameters": [
    [
      "Primary control",
      "Editable",
  ...
  "predictionDetails": [
    "Use the controls to inspect LSTM outputs on new examples.",
    "Outputs are computed locally in the browser session."
  ],
  "chartTitle": "LSTM Visualization",
  "chartLabels": [
    "Input",
    "Step",
    "Model",
  ...
  "modelOutput": [
    "LSTM parameters shown here",
    "intermediate values update per run",
    "predictions and reports are exportable"
  ],
  "warnings": [
    "LSTM is educational and browser-sized by default.",
  ...
  "learning": {
    "does": "Runs and visualizes LSTM in the browser.",
    "when": "Use it when LSTM matches the learning or experimentation goal.",
    "math": "The page highlights the core formula, matrix, loss, distance, probability, or update rule used by LSTM.",
