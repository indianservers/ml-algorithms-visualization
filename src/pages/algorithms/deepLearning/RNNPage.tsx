...
const config = {
  ...
  "icon": "deep",
  "title": "RNN",
  "subtitle": "Interactive browser-only RNN module with local datasets, controls, visualizations, metrics, and exports.",
  "category": "Deep Learning",
  "badge": "Intermediate",
  "explanation": "RNN has a dedicated physical lazy-loaded page. It provides algorithm-specific controls, browser-local dataset input, visualization, metrics, prediction or inspection output, limitations, and export actions without Python, a backend, or cloud ML APIs.",
  "hyperparameters": [
    [
      "Primary control",
      "Editable",
  ...
  "predictionDetails": [
    "Use the controls to inspect RNN outputs on new examples.",
    "Outputs are computed locally in the browser session."
  ],
  "chartTitle": "RNN Visualization",
  "chartLabels": [
    "Input",
    "Step",
    "Model",
  ...
  "modelOutput": [
    "RNN parameters shown here",
    "intermediate values update per run",
    "predictions and reports are exportable"
  ],
  "warnings": [
    "RNN is educational and browser-sized by default.",
  ...
  "learning": {
    "does": "Runs and visualizes RNN in the browser.",
    "when": "Use it when RNN matches the learning or experimentation goal.",
    "math": "The page highlights the core formula, matrix, loss, distance, probability, or update rule used by RNN.",
