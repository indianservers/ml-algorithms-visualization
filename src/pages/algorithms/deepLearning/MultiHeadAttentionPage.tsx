...
const config = {
  ...
  "subtitle": "Interactive browser-only Multi Head Attention module with local datasets, controls, visualizations, metrics, and exports.",
  "category": "Deep Learning",
  "badge": "Intermediate",
  "explanation": "Multi Head Attention runs as an interactive browser workbench. It provides algorithm-specific controls, browser-local dataset input, computed visualizations, live metrics, prediction or inspection output, limitations, and export actions without Python, a backend, or cloud ML APIs.",
  "hyperparameters": [
    [
      "Primary control",
      "Editable",
  ...
  "predictionDetails": [
    "Use the controls to inspect Multi Head Attention outputs on new examples.",
    "Outputs are computed locally in the browser session."
  ],
  "chartTitle": "Multi Head Attention Visualization",
  "chartLabels": [
    "Input",
    "Step",
    "Model",
  ...
  "modelOutput": [
    "Multi Head Attention parameters shown here",
    "intermediate values update per run",
    "predictions and reports are exportable"
  ],
  "warnings": [
    "Multi Head Attention is educational and browser-sized by default.",
  ...
  "learning": {
    "does": "Runs and visualizes Multi Head Attention in the browser.",
    "when": "Use it when Multi Head Attention matches the learning or experimentation goal.",
    "math": "The page highlights the core formula, matrix, loss, distance, probability, or update rule used by Multi Head Attention.",
