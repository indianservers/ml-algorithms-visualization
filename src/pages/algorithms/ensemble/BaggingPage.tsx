...
const config = {
  ...
  "icon": "ensemble",
  "title": "Bagging",
  "subtitle": "Interactive browser-only Bagging module with local datasets, controls, visualizations, metrics, and exports.",
  "category": "Ensemble",
  "badge": "Intermediate",
  "explanation": "Bagging runs as an interactive browser workbench. It provides algorithm-specific controls, browser-local dataset input, computed visualizations, live metrics, prediction or inspection output, limitations, and export actions without Python, a backend, or cloud ML APIs.",
  "hyperparameters": [
    [
      "Primary control",
      "Editable",
  ...
  "predictionDetails": [
    "Use the controls to inspect Bagging outputs on new examples.",
    "Outputs are computed locally in the browser session."
  ],
  "chartTitle": "Bagging Visualization",
  "chartLabels": [
    "Input",
    "Step",
    "Model",
  ...
  "modelOutput": [
    "Bagging parameters shown here",
    "intermediate values update per run",
    "predictions and reports are exportable"
  ],
  "warnings": [
    "Bagging is educational and browser-sized by default.",
  ...
  "learning": {
    "does": "Runs and visualizes Bagging in the browser.",
    "when": "Use it when Bagging matches the learning or experimentation goal.",
    "math": "The page highlights the core formula, matrix, loss, distance, probability, or update rule used by Bagging.",
